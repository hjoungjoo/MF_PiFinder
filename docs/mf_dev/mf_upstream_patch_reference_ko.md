...
| 9 | #621 `ef7e7928` | Stellarium 초기화용 사이트·시각 명령과 응답 추가. MF TCP 버퍼, `MS` 기반 실제 GoTo, Align, 음수 0도 적위, 좌표 epoch, 실제 이동 상태·정지, 짧은 연결 가이드 동작 유지. [상세 분석](mf_stellarium_push_port_analysis_ko.md). |

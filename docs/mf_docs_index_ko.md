...
| 문서 | ko/en | 상태 | 요약 |
|---|---|---|---|
| [field_test_20260724_analysis](mf_field_test_20260724_analysis_ko.md) | ko | **분석+수정 진행 중**(2026-07-25) | 현장 테스트 장애 분석(무시간원 시계 오차; IMU 폴백 자동 정렬은 의도된 설계로 확정)과 수정 체크리스트. |
...
| [auto_exposure_plan](mf_auto_exposure_plan_ko.md) | ko | **구현 완료(현장 검증 대기)** | 검출 별 수 컨트롤러 설계+구현 — 기존 기능 유지, Camera Exp 메뉴 "Auto Star"(`camera_exp=auto_star`)로 선택. ADR 0020. |

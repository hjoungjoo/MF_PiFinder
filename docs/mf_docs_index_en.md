...
| [indi_serial_auto_discovery_design](mf_dev/mf_indi_serial_auto_discovery_design_ko.md) | ko | **pre-implementation design** (2026-08-13) | When Auto is selected in the Web serial-port field, probe attached devices across supported baud rates with `:GVP#`/`:GVN#` and persist the verified stable port and speed. |

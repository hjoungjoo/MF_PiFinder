...
| [gps_ubx_recovery_20260909](mf_report/mf_gps_ubx_recovery_20260909_ko.md) | ko | **incident / change report** | Intermittent NMEA-only u-blox identification stall, bounded MON-VER retry, regression, TCP and live-device verification. |

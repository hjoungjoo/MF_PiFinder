...
| [mono_sqm_colour_guard_20260805](mf_report/mf_mono_sqm_colour_guard_20260805_en.md) | en | **announcement** (2026-08-05) | Community share — how upstream #560's sky-colour SQM correction silently shifts a mislabeled mono imx462 by +0.74 mag, the `profile.mono` guard, and how to test your own module. |

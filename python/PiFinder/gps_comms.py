...
class CommsPublisher:
    ...
    process when it drains the queue, with its own monotonic clock. This is
    the process the STATUS screen renders in, so the age measures time since
    main received the last reported event, not time spent waiting in the queue.

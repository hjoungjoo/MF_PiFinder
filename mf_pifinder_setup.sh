...
# It is identical to pifinder_setup.sh except that it clones this fork
# (hjoungjoo/MF_PiFinder, mf_pifinder branch) instead of the upstream release.
# See https://pifinder.readthedocs.io/en/release/software.html for more info.
#
# Install with:
#   wget -O - https://raw.githubusercontent.com/hjoungjoo/MF_PiFinder/mf_pifinder/mf_pifinder_setup.sh | bash
